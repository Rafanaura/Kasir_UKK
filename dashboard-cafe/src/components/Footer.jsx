...
//                             <a href="/#" <li></li>className="social-icon-link bi-facebook"></a></li>

//                             <li><a href="/#" className="social-icon-link bi-instagram"></a></li>

//                             <li><a href="https://twitter.com/search?q=tooplate.com&src=typed_query&f=live" className
//                             	 ="social-icon-link bi-twitter"></a></li>
...
//                         Design: <a rel="nofollow" href="https://www.tooplate.com/" className>Tooplate</a></p>
